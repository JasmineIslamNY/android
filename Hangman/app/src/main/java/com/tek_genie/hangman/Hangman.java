...
public class Hangman extends AppCompatActivity {
    ...
    */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gameObject = (HangmanDAO) intent.getSerializableExtra("gmObject");
        ...
        */
        ...
        //findViewById(R.id.buttonSubmitLetter).setOnTouchListener(mDelayHideTouchListener);
        //findViewById(R.id.buttonGameComplete).setOnTouchListener(mDelayHideTouchListener);
